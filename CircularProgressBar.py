...
_DEFAULT_THICKNESS = 3
_DEFAULT_CAP_STYLE = 'round'
_DEFAULT_PRECISION = 10
_DEFAULT_PROGRESS_COLOUR = (17 / 255, 125 / 255, 171 / 255, 1)
_DEFAULT_BACKGROUND_COLOUR = (0.1, 0.1, 0.1, 1)
_DEFAULT_MAX_PROGRESS = 100
_DEFAULT_MIN_PROGRESS = 0
_DEFAULT_WIDGET_SIZE = 50
# _DEFAULT_TEXT_LABEL = Label(text="{}%", font_size=14)
...
class CircularProgressBar(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self._text_label = Label(text="{}%", font_size=14)
        ...
        self._default_label_text = self._text_label.text
    ...
    def _draw(self):
        ...
        with self.canvas:
            ...
            print(self._text_label.texture)
